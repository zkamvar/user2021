...
.large-brain[The **.c-blue[Instructor]**]
...
.large-brain[The **.c-blue[Learner]**]
???
...
.large-brain[The **.c-blue[Educator]**]
???
...
---
class: center,middle
.galaxy-brain[**.c-light-blue[R] .c-blue[savior!]**]
...
---
background-image: url(git-window.png)
background-size: 80%
background-repeat: no-repeat
background-position: center
class: center
...
ALT: screen capture of visual studio code editor showing markdown from the
"Visualizing Tabular Data" from the Programming with Python lesson.

Our lessons are written in markdown and into a website via GitHub Pages and
the Jekyll static site generator.

---
background-image: url(lesson-window.png)
background-size: 80%
background-repeat: no-repeat
background-position: center
class: center
...
ALT: screen capture of Programming with Python Lesson showing the "Visualizing
Tabular Data" episode.
...
---
background-image: url(static-site-generators.png)
background-size: 80%
background-repeat: no-repeat
background-position: center
class: center
...
---
background-image: url(all-in-one-box.png)
background-size: 90%
background-repeat: no-repeat
background-position: center
...
ALT: a drawing of a box that says "Lesson" with three folders labelled "scripts",

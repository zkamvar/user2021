...
.pull-left[
.large-brain[
*&mdash;Greg Wilson* (Software Carpentries Founder)
]
.smol-brain[
...
---
class: center, middle
![Tweet from Greg Wilson that says "Me: tweets some grandiose thoughts about future directions for software engineering research. Also me: can't get Jekyll to run on an M1 MacBook Air.](gw-tweet.png)
...
???
All the scripts live _inside_ the repository.
...
background-size: 35%
background-repeat: no-repeat
background-position: right 0%, right 100%, left 5%, 55% 5%, left 95%, 55% 95%
class: middle
...
---
background-image: url(entrypoint.png)
background-size: cover
background-repeat: no-repeat
background-position: top
...
---
background-image: url(entrypoint-2.png)
background-size: cover
background-repeat: no-repeat
background-position: top
...
---
background-image: url(entrypoint-3.png)
background-size: cover
background-repeat: no-repeat
background-position: top
...
.large-brain[Thank you to our .c-light-blue[Carpentries Community]]

Funding from Community Initiatives and generous grants from
